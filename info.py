...
BOT_TOKEN = environ.get('BOT_TOKEN', "6097903927:AAHnf_qLiOIXj4i8_IgFXi1blJDganJs8GM")
...
SUBSCRIPTION = (environ.get('SUBSCRIPTION', 'https://graph.org/file/6c0ad0c99fe90843d602a.jpg'))
...
auth_channel = environ.get('AUTH_CHANNEL', '-1001907166812') #Channelid for force sub ( make sure bot is admin )
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1001926776709')).split()]
